function changeClass(){
    ...
    const usuarios = document.getElementById('contenedor-usuarios')
    ...
    usuarios.classList.toggle('contenedor-usuarios')
    usuarios.classList.toggle('contenedor-usuarios-check')
  } 