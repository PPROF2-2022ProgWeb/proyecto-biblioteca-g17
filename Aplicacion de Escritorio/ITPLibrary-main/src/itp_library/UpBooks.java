...
public class UpBooks extends javax.swing.JPanel {
    ...
    public UpBooks(String bid, String btitle, String bdate, String bauthor, String bcategory, String bedit, String blang, String bpages, String bstock, String bavai){
        initComponents();
        conn = new Connect();
        reg = conn.getConnection();
        edition = true;
    ...
    private void initComponents() {
        ...
        add(button, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 310, 260, 50));
        ...
        add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 260, 30));

        jSeparator7.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator7.setPreferredSize(new java.awt.Dimension(200, 10));
        add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 260, 10));

        Text7.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        Text7.setText("Año de Publicación");
        add(Text7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, -1, -1));
        ...
        add(date, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 260, 30));

        jSeparator8.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator8.setPreferredSize(new java.awt.Dimension(200, 10));
        add(jSeparator8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 260, 10));

        Text8.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        Text8.setText("Autor");
        add(Text8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, -1, -1));
        ...
        add(author, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 190, 260, 30));

        jSeparator9.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator9.setPreferredSize(new java.awt.Dimension(200, 10));
        add(jSeparator9, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 220, 260, 10));

        Text9.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        Text9.setText("Categoría");
        add(Text9, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 240, -1, -1));
        ...
        add(category, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 260, 260, 30));

        jSeparator10.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator10.setPreferredSize(new java.awt.Dimension(200, 10));
        add(jSeparator10, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 260, 10));
        ...
        add(jSeparator11, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 360, 260, 10));
        ...
        add(Text4, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 50, -1, -1));
        ...
        add(lang, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 70, 260, 30));

        jSeparator5.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator5.setPreferredSize(new java.awt.Dimension(200, 10));
        add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 100, 260, 10));
        ...
        add(pages, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 130, 260, 30));

        jSeparator12.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator12.setPreferredSize(new java.awt.Dimension(200, 10));
        add(jSeparator12, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 160, 260, 10));

        Text13.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        Text13.setText("Stock");
        add(Text13, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 180, -1, -1));
        ...
        add(stock, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 200, 80, 30));

        jSeparator14.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator14.setPreferredSize(new java.awt.Dimension(200, 10));
        add(jSeparator14, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 230, 80, 10));
        ...
        add(available, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 200, 100, 30));

        jSeparator16.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator16.setPreferredSize(new java.awt.Dimension(200, 10));
        add(jSeparator16, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 230, 100, 10));

        Text15.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        Text15.setText("Disponibles");
        add(Text15, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 180, -1, -1));
    ...
    private void buttonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonMousePressed
        ...
        else
        {
            ...
            if(btitle == null || "".equals(btitle) || bdate == null || "".equals(bdate) 
                ...
                try{
                    ...
                    try {
                        if(edition)
                            EditBook(btitle, bdate, bathor, bcategory, bedit, blang, pag, stc, av);
                        else
                            InsertBook(btitle, bdate, bathor, bcategory, bedit, blang, pag, stc, av);
                    ...
                    javax.swing.JOptionPane.showMessageDialog(this, "Las páginas, el Stock, el Disponible, y el ID, deben ser números enteros. \n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                }
    ...
    public void InsertBook(String titu, String fech, String auth, String cate, String ed, String idiom, int pags, int stck, int avai) throws SQLException{
        Statement stm = reg.createStatement();
        
        try {
            stm.executeUpdate("INSERT INTO `books` (`title`, `date`, `author`, `category`, `edit`, `lang`, `pages`, `stock`, `available`) VALUES ('"+titu+"', '"+ fech +"', '"+ auth +"', '"+cate+"', '"+ed+"', '"+idiom+"', '"+pags+"', '"+stck+"', '"+avai+"')");
            javax.swing.JOptionPane.showMessageDialog(this, "¡Libro registrado correctamente! \n", "HECHO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
        } catch(SQLException ex){
            if(ex instanceof SQLIntegrityConstraintViolationException){
                javax.swing.JOptionPane.showMessageDialog(this, "No puedes ingresar un ID que ya existe \n", "ERROR", javax.swing.JOptionPane.INFORMATION_MESSAGE);
            }
        }
        
    }
    
    public void EditBook(String titu, String fech, String auth, String cate, String ed, String idiom, int pags, int stck, int avai) throws SQLException{
        Statement stm = reg.createStatement();
        stm.executeUpdate("UPDATE `books` SET `title` = '"+titu+"', `date` = '"+fech+"', `author` = '"+auth+"', `category` = '"+cate+"', `edit` = '"+ed+"', `lang` = '"+idiom+"', `pages` = '"+pags+"', `stock` = '"+stck+"', `available` = '"+avai+"' WHERE `id` = '"+ origId +"';");
