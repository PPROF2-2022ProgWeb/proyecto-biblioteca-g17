...
public class UpUsers extends javax.swing.JPanel {
    ...
    public UpUsers(String usid, String usname, String usap1, String usdoc, String usdom, String ustel) {
        initComponents();
        conn = new Connect();
        reg = conn.getConnection();
        idus = usid;
    ...
    private void initComponents() {
        ...
        ap1.setText("Ingrese el/los apellido/s");
        ap1.setBorder(null);
        ...
        ap2.setText("Ingrese el número de documento");
        ap2.setBorder(null);
    ...
    private void ap1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ap1MousePressed
        if(name.getText().equals("") || name.getText() == null || name.getText().equals(" "))
        name.setText("Ingrese el nombre");
       if(ap1.getText().equals("Ingrese el/los apellido/s"))
        ap1.setText("");
       if(ap2.getText().equals("") || ap2.getText() == null || ap2.getText().equals(" "))
        ap2.setText("Ingrese el número de documento");
       if(dom.getText().equals("") || dom.getText() == null || dom.getText().equals(" "))
    ...
    private void buttonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonMousePressed
        if(name.getText().equals("Ingrese el nombre") || ap1.getText().equals("Ingrese el apellido")
            || ap2.getText().equals("Ingrese el documento") || dom.getText().equals("Ingrese el domicilio")
        ...
        else
        {
            ...
            String udoc = ap2.getText();
            String udom = dom.getText();
            String utel = tel.getText();

            if(uname == null || "".equals(uname) || uapp == null || "".equals(uapp) || udoc == null || "".equals(udoc) || udom == null || "".equals(udom) || utel == null || "".equals(utel)){
                javax.swing.JOptionPane.showMessageDialog(this, "Debe llenar todos los campos \n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                name.requestFocus();
            }
            else{ 
                try {
                    if(edit)
                        EditUser(idus, uname, uapp, udoc, udom, utel);
                    else
                        InsertUser(uname, uapp, udoc, udom, utel);
    ...
    private void ap2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ap2MousePressed
       ...
       if(ap1.getText().equals("") || ap1.getText() == null || ap1.getText().equals(" "))
        ap1.setText("Ingrese el/los apellido/s");
       if(ap2.getText().equals("Ingrese el número de documento"))
        ap2.setText("");
       if(dom.getText().equals("") || dom.getText() == null || dom.getText().equals(" "))
        dom.setText("Ingrese el domicilio");
       if(tel.getText().equals("") || tel.getText() == null || tel.getText().equals(" "))
    ...
    public void InsertUser(String name, String app, String doc, String dom, String tel) throws SQLException{
        Statement stm = reg.createStatement();
        
        stm.executeUpdate("INSERT INTO `users` (`name`, `last_name`, `document`, `domicilio`, `tel`) VALUES ('"+name+"', '"+app+"', '"+ doc +"', '"+ dom +"', '"+tel+"')");
        javax.swing.JOptionPane.showMessageDialog(this, "¡Usuario registrado correctamente! \n", "HECHO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
        
    }
    
    public void EditUser(String id, String name, String app, String doc, String dom, String tel) throws SQLException{
        Statement stm = reg.createStatement();
        
        stm.executeUpdate("UPDATE `users` SET `name` = '"+name+"', `last_name` = '"+app+"', `document` = '"+doc+"', `domicilio` = '"+dom+"', `tel` = '"+tel+"' WHERE `id` = "+id+";");
